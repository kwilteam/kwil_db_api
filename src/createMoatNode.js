...
const {generateKeyPairNode} = require('./utils/generateKeyPairNode.js')

const createMoatNode = async (_registry, _moat, _signature, _walletAddr) => {
